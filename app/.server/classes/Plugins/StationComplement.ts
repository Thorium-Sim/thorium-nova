import { stationComplementSchema } from "@thorium/ecs-components/stationComplementSchema";
...
export default class StationComplementPlugin extends Aspect {
	static schema = stationComplementSchema;
	apiVersion = "stations/v1" as const;
	kind = "stationComplements" as const;
	name!: string;
	hasShipMap!: boolean;
	stations!: z.infer<typeof stationComplementSchema>["stations"];
