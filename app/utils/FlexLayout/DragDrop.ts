...
export class DragDrop {
	...
	/** @internal */
	private _manualGlassManagement = false;
	/** @internal */
	...
	/** @internal */
	private _glassShowing = false;
	/** @internal */
	private _dragging = false;
	/** @internal */
	private _active = false; // drag and drop is in progress, can be used on ios to prevent body scrolling (see demo)
	/** @internal */
