import { BORDER_NODE } from "@thorium/utils/FlexLayout/model/NODE_TYPES";
...
import type { IJsonBorderNode } from "./IJsonModel";
import type { Model, ILayoutMetrics } from "./Model";
import { Node } from "./Node";
import { SplitterNode } from "./SplitterNode";
import { TabNode } from "./TabNode";
import type { TabSetNode } from "./TabSetNode";
import { adjustSelectedIndex } from "./utils/adjustSelectedIndex";

export class BorderNode extends Node implements IDropTarget {
	static readonly TYPE = BORDER_NODE;
	...
	/** @internal */
	private _adjustedSize = 0;
	/** @internal */
	private _calculatedBorderBarSize = 0;
	...
	/** @internal */
	_getSplitterBounds(splitter: SplitterNode, useMinSize = false) {
		const pBounds = [0, 0];
