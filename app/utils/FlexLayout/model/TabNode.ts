import { TAB_NODE } from "@thorium/utils/FlexLayout/model/NODE_TYPES";
...
export class TabNode extends Node implements IDraggable {
	static readonly TYPE = TAB_NODE;

	/** @internal */
	static _fromJson(json: any, model: Model, addToModel = true) {
	...
	/** @internal */
	constructor(model: Model, json: any, addToModel = true) {
		super(model);
