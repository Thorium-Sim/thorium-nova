				...
				<div className="flex-1 pr-4">
						...
						<Input
							...
							label={
								<>
									...
									<InfoTip>
										Cargo is moved through the ship inside cargo containers. Choose a number of
										cargo containers that make the quartermaster carefully plan the cargo transfers.
									</InfoTip>
								</>
							}
							placeholder="4"
					...
					<div className="pb-4">
						<p>
							...
							<strong>{ship.cargoContainers * ship.cargoContainerVolume} L</strong>
						</p>
					</div>
				</div>
			</div>
