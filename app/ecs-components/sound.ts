...
export const sound = z.object({
	...
	/** At what point in the sound as a percent of the duration the loop returns to */
	loopStart: z.number().nullable().default(null),
	/** At what point in the sound as a percent of the duration the loop ends, allowing for the sound to finish playing when the loop is done */
