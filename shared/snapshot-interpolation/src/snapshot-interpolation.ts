import { Snapshot, InterpolatedSnapshot, Time, Value, State, Entity } from './types'
...
export class SnapshotInterpolation {
  ...
  public calcInterpolation(parameters: string, deep: string = ''): InterpolatedSnapshot | undefined {
