			...
			<div className="w-full">
				...
				<div className="flex gap-4 flex-wrap">
					...
					<div className="form-control">
						...
						<input type="text" className="input input-notice" />
					</div>
				</div>
			</div>
			<div>
				...
				<div className="flex gap-4 flex-wrap">
					...
					<div className="form-control">
						<label className="label">Secondary</label>
						<textarea className="textarea textarea-secondary" />
					</div>
					<div className="form-control">
						<label className="label">Accent</label>
					...
					<div className="form-control">
						<label className="label">Success</label>
						<textarea className="textarea textarea-success" />
					</div>
					<div className="form-control">
						<label className="label">Warning</label>
						<textarea className="textarea textarea-warning" />
					</div>
					<div className="form-control">
						<label className="label">Error</label>
					...
					<div className="form-control">
						<label className="label">Notice</label>
						<textarea className="textarea textarea-notice" />
					</div>
				</div>
			</div>
			<div>
